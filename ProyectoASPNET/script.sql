USE [master]
GO
/****** Object:  Database [BBDDPROYECTO]    Script Date: 05/03/2024 23:40:18 ******/
...
USE [BBDDPROYECTO]
GO
/****** Object:  Table [dbo].[RESTAURANTES]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORIAS_RESTAURANTES]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[VALORACIONES_RESTAURANTE]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[V_RESTAURANTES]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	R.DIRECCION, R.IMAGEN, R.TIEMPOENTREGA, CR.NOMBRECATEGORIA
GO
/****** Object:  Table [dbo].[CATEGORIAS_PRODUCTOS]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ESTADOS_PEDIDOS]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PEDIDOS]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PRODUCTO_CATEGORIAS]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PRODUCTOS]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PRODUCTOS_PEDIDO]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TIPOS_USUARIOS]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USUARIOS]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[PRODUCTOS] ([IDPRODUCTO], [NOMBRE], [DESCRIPCION], [PRECIO], [IMAGEN], [IDRESTAURANTE]) VALUES (4, N'Tarta de Queso', N'Casera con mermelada
', CAST(6.00 AS Decimal(5, 2)), N'img4.jpeg', 1)
GO
...
GO
INSERT [dbo].[PRODUCTOS] ([IDPRODUCTO], [NOMBRE], [DESCRIPCION], [PRECIO], [IMAGEN], [IDRESTAURANTE]) VALUES (6, N'Pizza Fumé', N'Pesto, mozzarella, scarmorza ahumada, cebolla morada, orégano
...
GO
INSERT [dbo].[USUARIOS] ([IDUSUARIO], [NOMBRE], [APELLIDOS], [CORREO], [CONTRASENYA], [SALT], [TELEFONO], [DIRECCION], [TIPOUSUARIO]) VALUES (1, N'admin', N'admin', N'admin@gmail.com', 0x7468F39A121F6BDC36155670A60414B5303522F4306A185E39AA35E86B766C45ED2CBC36E96D1E6009B8641B823BD987A90B2BC8E529747B3A45D8F27DF5F059, N'ú©9ä¼³ºýò:dI*½óÚÉZ5ì9ym¹@á·µÇ6ñu[dsj64''l&$-', N'617812153', N'Calle O'' Donell 51, Madrid', 2)
GO
INSERT [dbo].[USUARIOS] ([IDUSUARIO], [NOMBRE], [APELLIDOS], [CORREO], [CONTRASENYA], [SALT], [TELEFONO], [DIRECCION], [TIPOUSUARIO]) VALUES (2, N'Alejandro', N'López Labajo', N'alopezlabajo.02@gmail.com', 0xA658D3FBAE1FFCDA5179DDD0A2F16A41348871010C5C87F80DAE2C03D3A3407CF818E4EF47F0C5D556F5966F4ACBB57C1CDE1154FBABCA49FE10A7950F6275CD, N'ª<CEéÎ&Ñ¹x]Dï&Y£,ìÀ=Òâé,@»À£aUÌýns¶''RG', N'617812153', N'Calle Vizconde de Arlessón 31, Madrid', 1)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UNIQUE_CORREO_USUARIOS]    Script Date: 05/03/2024 23:40:18 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_USUARIO]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_PRODUCTOS_CATEGORIA]    Script Date: 05/03/2024 23:40:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
