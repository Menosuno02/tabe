USE [master]
GO
/****** Object:  Database [BBDDPROYECTO]    Script Date: 08/03/2024 0:16:01 ******/
...
USE [BBDDPROYECTO]
GO
/****** Object:  Table [dbo].[RESTAURANTES]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORIAS_RESTAURANTES]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[VALORACIONES_RESTAURANTE]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[V_RESTAURANTES]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	R.DIRECCION, R.IMAGEN, R.TIEMPOENTREGA, CR.NOMBRECATEGORIA
GO
/****** Object:  Table [dbo].[ESTADOS_PEDIDOS]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PEDIDOS]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PRODUCTOS]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PRODUCTOS_PEDIDO]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[V_PRODUCTOS_PEDIDO]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORIAS_PRODUCTOS]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PRODUCTO_CATEGORIAS]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TIPOS_USUARIOS]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USUARIOS]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[PEDIDOS] ([IDPEDIDO], [IDUSUARIO], [IDRESTAURANTE], [ESTADO], [FECHA]) VALUES (1, 2, 1, 1, CAST(N'2024-03-06T19:39:25.000' AS DateTime))
GO
...
', N'Extra de mozarrella, cebolla dulce, ají molido y orégano
...
GO
INSERT [dbo].[RESTAURANTES] ([IDRESTAURANTE], [NOMBRE], [TELEFONO], [DIRECCION], [IMAGEN], [IDCATEGORIA], [TIEMPOENTREGA]) VALUES (2, N'Chila', N'915302673', N'Calle De Silva 4, Madrid, Community of Madrid 28013', N'img2.jpeg', 4, N'20')
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UNIQUE_CORREO_USUARIOS]    Script Date: 08/03/2024 0:16:02 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_USUARIO]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_PRODUCTOS_CATEGORIA]    Script Date: 08/03/2024 0:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
